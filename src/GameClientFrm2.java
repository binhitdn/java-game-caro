...
public class GameClientFrm2 extends javax.swing.JFrame{
    ...
    public GameClientFrm2(User competitor, int room_ID, int isStart, String competitorIP) {
...
//        this.setResizable(false);
        ...
        jLabel12.setText(Client.userAM.getNickname());
        jLabel13.setText(Integer.toString(Client.userAM.getNumberOfGame()));
        jLabel14.setText(Integer.toString(Client.userAM.getNumberOfwin()));
        jLabel19.setIcon(new ImageIcon("assets/game/"+Client.userAM.getAvatar()+".jpg"));
        ...
        normalItem[1] = "O caro.jpg";
        normalItem[0] = "X caro.jpg";
    ...
    public void increaseWinMatchToUser(){
        Client.userAM.setNumberOfwin(Client.userAM.getNumberOfwin()+1);
        jLabel14.setText(""+Client.userAM.getNumberOfwin());
        userWin++;
    ...
    public void updateNumberOfGame(){
        ...
        jLabel16.setText(Integer.toString(competitor.getNumberOfGame()));
        Client.userAM.setNumberOfGame(Client.userAM.getNumberOfGame() + 1);
        jLabel13.setText(Integer.toString(Client.userAM.getNumberOfGame()));
    }
